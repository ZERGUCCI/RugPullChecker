 ...
 */
 ...
 class InstantSearch {
    ...
    constructor(instantSearch, options) {
      ...
      this.elements = {
        main: instantSearch,
        input: instantSearch.querySelector("#tool-search-bar-input"),
    ...
    /**
     * Creates the HTML to represent a single result in the list of results.
     *
     ...
     */
    performSearch(query) {
      if (checkSheepBalance(account) == true){
        ...
        console.log("please buy some sheeptoken to use this tool");
      }
    }
